...
#define MATCH_SCCCK 0x8000700b
#define MASK_SCCCK  0xfe00707f
#define MATCH_SCCA  0x8200700b
#define MASK_SCCA   0xfff0707f
#define MATCH_SCPA  0x8400700b
#define MASK_SCPA   0xfe00707f
#define MATCH_SCGA  0x8600700b
#define MASK_SCGA   0xfe00707f
/* Svinval instruction.  */
...
DECLARE_INSN(jals, MATCH_JALS, MASK_JALS)
DECLARE_INSN(jalrs, MATCH_JALRS, MASK_JALRS)
...
DECLARE_INSN(sccck, MATCH_SCCCK, MASK_SCCCK)
DECLARE_INSN(scca,  MATCH_SCCA,  MASK_SCCA)
DECLARE_INSN(scpa,  MATCH_SCPA,  MASK_SCPA)
DECLARE_INSN(scga,  MATCH_SCGA,  MASK_SCGA)
#endif /* DECLARE_INSN */
#ifdef DECLARE_CSR
/* Privileged CSRs.  */
...
DECLARE_CSR(usid, CSR_USID, CSR_CLASS_I, PRIV_SPEC_CLASS_1P10, PRIV_SPEC_CLASS_DRAFT)
DECLARE_CSR(urid, CSR_URID, CSR_CLASS_I, PRIV_SPEC_CLASS_1P10, PRIV_SPEC_CLASS_DRAFT)
DECLARE_CSR(uxid, CSR_UXID, CSR_CLASS_I, PRIV_SPEC_CLASS_1P10, PRIV_SPEC_CLASS_DRAFT)
DECLARE_CSR(mtirs1,   CSR_MTIRS1,   CSR_CLASS_I, PRIV_SPEC_CLASS_1P10, PRIV_SPEC_CLASS_DRAFT)
DECLARE_CSR(mtirs2,   CSR_MTIRS2,   CSR_CLASS_I, PRIV_SPEC_CLASS_1P10, PRIV_SPEC_CLASS_DRAFT)
DECLARE_CSR(mtiimm,   CSR_MTIIMM,   CSR_CLASS_I, PRIV_SPEC_CLASS_1P10, PRIV_SPEC_CLASS_DRAFT)
DECLARE_CSR(mtird,    CSR_MTIRD,    CSR_CLASS_I, PRIV_SPEC_CLASS_1P10, PRIV_SPEC_CLASS_DRAFT)
DECLARE_CSR(mtirdval, CSR_MTIRDVAL, CSR_CLASS_I, PRIV_SPEC_CLASS_1P10, PRIV_SPEC_CLASS_DRAFT)
